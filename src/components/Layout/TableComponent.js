...
export const TableComponent = props => {
  ...
  const onGridReady = params => {
    if (
      props.title !== 'Manage Clients' &&
      props.title !== 'Manage Insurance Details' &&
      props.title !== 'Manage Term Deposits' &&
      props.title !== 'Manage Transactions'
    ) {
      if (
        width <= 800 &&
        (props.title === 'Manage Verticals' ||
          props.title === 'Manage SubVerticals' ||
          props.title === 'Manage Vendors')
      ) {
